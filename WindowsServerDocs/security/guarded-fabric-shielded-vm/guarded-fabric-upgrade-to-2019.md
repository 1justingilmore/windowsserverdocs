...
3.  [Test and re-enable](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-application-control/audit-windows-defender-application-control-policies) your Microsoft Defender Application Control policy, if you had one enabled before the upgrade.
